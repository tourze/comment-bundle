...
final class ContentFilterServiceTest extends TestCase
{
    ...
    public function testIsContentSafeWithValidContent(): void
    {
    ...
    public function testIsContentSafeWithTooShortContent(): void
    {
        $content = '';
    ...
    public function testIsContentSafeWithTooLongContent(): void
    {
    ...
    public function testIsContentSafeWithSpamWords(): void
    {
        $spamContents = [
            '这是垃圾邮件',
    ...
    public function testIsContentSafeWithProfanity(): void
    {
        $profaneContents = [
            '你真是个傻逼',
    ...
    public function testIsContentSafeWithExcessiveRepetition(): void
    {
        $repetitiveContents = [
            'aaaaaaaaaaaaa',
    ...
    public function testIsContentSafeWithSuspiciousLinks(): void
    {
        $suspiciousContents = [
    ...
    public function testFilterContentRemovesProfanity(): void
    {
    ...
    public function testFilterContentNormalizesWhitespace(): void
    {
    ...
    public function testGetFilteredReasonReturnsCorrectReason(): void
    {
        $testCases = [
            ['', '内容长度不符合要求'],
    ...
    public function testAnalyzeContentReturnsCompleteAnalysis(): void
    {
    ...
    public function testDisabledFiltersAllowContent(): void
    {
